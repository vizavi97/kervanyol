$.fn.fileUploader = function (filesToUpload, sectionIdentifier) {
  ...
  this.closest(".files").change(function (evt) {
    ...
    for (var i = 0; i < evt.target.files.length; i++) {
      ...
      var removeLink = "<a class=\"removeFile cabinet-edit-data-load-complete-delete\" href=\"#\" data-fileid=\"" + fileId + "\"><span class=\"icon-delete\"></span></a>";
      output.push("<div class=\"cabinet-edit-data-load-complete\">\n" +
        "  <div class=\"cabinet-edit-data-load-complete-img\">\n" +
        "  <span class=\"icon-file1\"></span>\n" +
        "</div>\n" +
        "<div class=\"cabinet-edit-data-load-complete-text\">\n" +
        "<h5>" + escape(file.name) + "</h5></div>" + removeLink + "</div>")
